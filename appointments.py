...
def get_appt_days(id, vaccine_data, start, end, dose=1):
    ...
    burp0_headers = {"Connection": "close", "User-Agent": "TwitterVaccineBot", "Content-Type": "application/json;charset=UTF-8", "Origin": "https://myturn.ca.gov", "Sec-Fetch-Site": "same-site", "Sec-Fetch-Mode": "cors", "Sec-Fetch-Dest": "empty", "Referer": "https://myturn.ca.gov/", "Accept-Encoding": "gzip, deflate", "Accept-Language": "en-US,en;q=0.9"}
