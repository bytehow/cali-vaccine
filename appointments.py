...
def get_appt_days(id, start, end, dose=1):
    ...
    # There's a DB consistency issue we need to work around. Check twice before reporting
    ...
    appts2 = [apt['date'] for apt in resp_json2['availability'] if apt['available']]

    # Only return what is returned in both
    return list(set(appts).intersection(set(appts2)))
